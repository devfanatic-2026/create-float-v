...
const useCounterStore = createFloatStore<CounterState>({
    count: 0,
    step: 1,
});
...
export default function CounterPage() {
    ...
    const increment = () => useCounterStore.setState({ count: count + step });
    const decrement = () => useCounterStore.setState({ count: count - step });
    const reset = () => useCounterStore.setState({ count: 0 });
    const setStep = (val: number) => useCounterStore.setState({ step: val });
    const setCount = (val: number) => useCounterStore.setState({ count: val });
    ...
    return (
        <div className="max-w-2xl mx-auto">
            <div className="mb-8">
                ...
                <p className="text-gray-600 mt-2">State management using <code>createFloatStore</code></p>
            </div>
...
const useCounterStore = createFloatStore({
  count: 0,
  step: 1,
});
