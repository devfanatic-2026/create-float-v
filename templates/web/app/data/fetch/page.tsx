...
import { useFloatData } from '@float-v/core';
    ...
    return (
        <div className="max-w-5xl mx-auto">
            <div className="mb-8">
                ...
                <p className="text-gray-600 mt-2">Async data loading using <code>useFloatData</code></p>
            </div>
            ...
            {isLoading && products.length === 0 ? (
                ...
                <div className="bg-red-50 border border-red-200 rounded-xl p-8 text-center text-red-600">
                    ...
                    <p>{error.message}</p>
                    <button onClick={() => refresh()} className="mt-4 text-red-700 underline">Try Again</button>
                </div>
            ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
