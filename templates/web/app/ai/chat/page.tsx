...
const useChatStore = createFloatStore<ChatState>({
    messages: [
...
export default function AIChatPage() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        useChatStore.setState(state => ({
            messages: [...state.messages, { role: 'user', content: userMsg }],
            isTyping: true
        }));
    ...
    return (
        <div className="max-w-2xl mx-auto h-[calc(100vh-12rem)] flex flex-col py-8">
            <div className="mb-4">
