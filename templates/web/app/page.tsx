    ...
    return (
        <div className="space-y-8">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
                <h1 className="text-4xl font-bold mb-4">Float-V Web Showcase</h1>
                ...
                <div className="flex flex-wrap gap-4">
                    ...
                    <div className="bg-white/20 backdrop-blur-sm rounded-lg px-4 py-2">
                        ...
                        <div className="text-2xl font-bold">@float-v/core</div>
                    </div>
                </div>
            </div>
                ...
                <div className="flex flex-col md:flex-row gap-4">
                    ...
                    <div className="flex gap-2 flex-wrap">
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg font-medium transition-colors ${selectedCategory === 'all' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
                        >
                            All
                        </button>
