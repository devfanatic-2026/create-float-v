...
```bash
npx create-float-v@latest
```

Follow the interactive prompts to choose your project type and name.
...
- **Package Manager**: Recommended `pnpm`, but works with `npm` or `yarn`.
