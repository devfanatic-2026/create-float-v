...
const templates: Template[] = [
  {
    name: 'Default',
    description: 'Basic Float-V app with TypeScript',
    value: 'default',
  },
  {
    name: 'Minimal',
...
function createProject(projectDir: string, options: ProjectOptions) {
  ...
  const floatConfig = typescript
    ? `import type { FloatConfig } from '@float-v/core';
...
`
    : `/** @type {import('@float-v/core').FloatConfig} */
const config = {
  reactStrictMode: true,
};
...
`;
  ...
  // Create Float-V Welcome Home Page
  const pageContent = `
      ...
      <footer className="footer">
        <div className="footer-inner">
          ...
          <div className="footer-bottom">
            <p>© 2026 Float-V. MIT Licensed. Edit <strong>app/page.tsx</strong> to get started.</p>
            <div className="footer-social">
              <a href="https://github.com/float-v/float-v">
              ...
              <a href="https://www.npmjs.com/package/@float-v/core">
                <svg viewBox="0 0 24 24" fill="currentColor">
...
`;
  ...
  const agentInstructions = `# Agent Instructions for Float-V

You are an expert developer working on a Float-V project.
Float-V is an ultra-modern web framework for React.

## Project Structure
- \`app/\`: File-based routing (layouts and pages)
- \`public/\`: Static assets
- \`float.config.ts\`: Framework configuration

## Guidelines
- Use React 19 features.
- Follow the file-based routing conventions.
- Stay oriented to "vibe-coding": fast, iterative, and high-quality code.
`;
  fs.writeFileSync(path.join(agentDir, 'instructions.md'), agentInstructions);

  // Create README
  const readme = `# ${name}

Built with [Float-V](https://github.com/float-v/float-v) - Ultra Modern Web Framework
...
- [Float-V Documentation](https://float-v.org/docs)
- [Examples](https://github.com/float-v/float-v/tree/main/examples)
`;
