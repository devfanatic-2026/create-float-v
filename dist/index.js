...
async function main() {
  ...
  console.log(pc.cyan(`
\u{1F4C1} Creating project in ${pc.bold(projectDir)}...
`));
...
function createProject(projectDir, options) {
  ...
  const packageJson = {
    ...
    scripts: {
      ...
      build: "float build",
      start: "float start",
      lint: eslint ? "eslint . --ext .ts,.tsx" : void 0
    },
    dependencies: {
      "@float-v/core": "^2.0.3",
      react: "^18.2.0",
  ...
  Object.keys(packageJson.scripts).forEach((key) => {
    if (packageJson.scripts[key] === void 0) {
  ...
  const floatConfig = typescript ? `import type { FloatConfig } from '@float/core';
...
`;
  ...
  const layoutContent = typescript ? `import type { ReactNode } from 'react';
      ...
      <footer className="footer">
        <div className="footer-inner">
          ...
          <div className="footer-bottom">
            <p>\xA9 2026 Float.js. MIT Licensed. Edit <strong>app/page.tsx</strong> to get started.</p>
